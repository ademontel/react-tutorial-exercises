...
const BootstrapCard = (properties) => {
	// 1) Replace the hard-coded image, description, link, etc. With their property variable
	return (
		<div className="card m-5">
			<img className="card-img-top" src={properties.imageUrl} alt="Card image cap" />
			<div className="card-body">
				<h5 className="card-title">{properties.title}</h5>
				<p className="card-text">{properties.description}</p>
				<a href={properties.buttonUrl} className="btn btn-primary">
